...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Autor assis = geraAutor("Machado de Assis","lorem@lerem1.com.br");
		em.persist(assis);

		Autor amado = geraAutor("Jorge Amado","lorem@lerem2.com.br");
		em.persist(amado);

		Autor coelho = geraAutor("Paulo Coelho","lorem@lerem3.com.br");
		em.persist(coelho);

		Autor lobato = geraAutor("Monteiro Lobato","lorem@lerem4.com.br");
		em.persist(lobato);
